...
Null m=0.583 (measured STAGED cell rate, SO2+SO3 BASE+SO4, 14/24) and 0.667, effect m=0.95; per-world Beta(m c, (1-m) c)
heterogeneity at c = inf (0), 4, 2, 1 (SO3/SO4 imply c ~ 3.9); three Bernoulli streams per world; seed 11.
"""
import numpy as np
W, S, N = 7, 3, 20000
...
for conc in (0, 4, 2, 1):
    ...
    for mean in (0.583, 0.667, 0.8, 0.9, 0.95, 0.98):
